...
213 FORMAT('1_chlorophyll_',a,'.nc')

  write(*,*) '%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%'
  write(*,*) ' build_NEMO_child_chlorophyll_from_ORCA025 :         '
  write(*,*) ' ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~           '
  write(*,*) '                                                     '
...
status = NF90_PUT_ATT(fidout,NF90_GLOBAL,"history","created using build_NEMO_child_chlorophyll_from_ORCA025.f90")
