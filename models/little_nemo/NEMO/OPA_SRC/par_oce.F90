...
#elif defined key_trop075
   !!---------------------------------------------------------------------
   !!   'key_trop075' :             regional basin : Tropical Channel R075
   !!---------------------------------------------------------------------
#             include "par_TROP075.h90"
#elif defined key_trop025
   !!---------------------------------------------------------------------
   !!   'key_trop025' :             regional basin : Tropical Channel R025
   !!---------------------------------------------------------------------
#             include "par_TROP025.h90"
#elif defined key_trop12
   !!---------------------------------------------------------------------
   !!   'key_trop12' :                          Tropical Periodic : TROP12
   !!---------------------------------------------------------------------
#             include "par_TROP12.h90"
#elif defined key_mc75
   !!---------------------------------------------------------------------
   !!   'key_mc75' :                             Maritime Continent : MC75
   !!---------------------------------------------------------------------
#             include "par_MC75.h90"
#elif defined key_mc750
   !!---------------------------------------------------------------------
   !!   'key_mc750' :                           Maritime Continent : MC750
   !!---------------------------------------------------------------------
#             include "par_MC750.h90"
#elif defined key_mc25
   !!---------------------------------------------------------------------
   !!   'key_mc25' :                             Maritime Continent : MC25
   !!---------------------------------------------------------------------
#             include "par_MC25.h90"
#elif defined key_mc250
   !!---------------------------------------------------------------------
   !!   'key_mc250' :                           Maritime Continent : MC250
   !!---------------------------------------------------------------------
#             include "par_MC250.h90"
#elif defined key_cordex24
   !!---------------------------------------------------------------------
   !!   'key_cordex24' :                      Australian CORDEX : cordex24
   !!---------------------------------------------------------------------
#             include "par_cordex24.h90"
#elif defined key_cordex50
   !!---------------------------------------------------------------------
   !!   'key_cordex50' :            regional basin : CORDEX Australian dom
   !!---------------------------------------------------------------------
#             include "par_CORDEX50.h90"
#elif defined key_bb12
   !!---------------------------------------------------------------------
   !!   'key_bb12'      :                   regional basin : bay of bengal
   !!---------------------------------------------------------------------
#             include "par_BB12.h90"
#elif defined key_peru12
   !!---------------------------------------------------------------------
   !!   'key_peru12'      :                    regional basin : Peru/Chile
   !!---------------------------------------------------------------------
#             include "par_PERU12.h90"
#elif defined key_narc025
   !!---------------------------------------------------------------------
   !!   'key_narc025' :               regional basin : North Atlantic R025
   !!---------------------------------------------------------------------
#             include "par_NARC025.h90"
#else
   !!---------------------------------------------------------------------
