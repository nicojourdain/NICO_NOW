...
write(file_mesh_mask_par,385) TRIM(conf_par)
385 FORMAT('mesh_mask_',a,'.nc')

  write(*,*) '%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%'
  write(*,*) ' build_parent_3D_intrp_coeff_from_ORCA025 :          '
  write(*,*) ' ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~            '
  write(*,*) '                                                     '
...
!-- OBC output file
write(file_coeff,102) TRIM(conf_par)
102 FORMAT('coeff_3D_',a,'_from_ORCA025.nc')
...
!-- Global attribute
status = NF90_PUT_ATT(fidcoeff,NF90_GLOBAL,"history","build_NEMO_nest025_from_MC25_3D_intrp_coeff.f90") ; call erreur(status,.TRUE.,"att_global")
...
!-- End of writing                           
status = NF90_CLOSE(fidcoeff) ; call erreur(status,.TRUE.,"end_writing_OBC")
