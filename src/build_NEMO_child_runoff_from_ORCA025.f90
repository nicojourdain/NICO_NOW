...
!                                                                    !
! NB: coeff_3D_nest025_from_ORCA025.nc has to be created before      ! 
!                                                                    !
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
213 FORMAT('1_runoff_',a,'.nc')

  write(*,*) '%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%'
  write(*,*) ' build_NEMO_child_runoff_from_ORCA025 :              '
  write(*,*) ' ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~                '
  write(*,*) '                                                     '
...
status = NF90_PUT_ATT(fidout,NF90_GLOBAL,"history","created using build_NEMO_child_runoff_from_ORCA025.f90")
